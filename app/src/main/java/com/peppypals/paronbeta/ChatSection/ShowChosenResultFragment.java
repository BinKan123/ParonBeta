...
public class ShowChosenResultFragment extends Fragment {

    public ShowChosenResultFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_show_chosen_result, container, false);
//
